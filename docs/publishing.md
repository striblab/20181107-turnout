...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/turnout">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/turnout/styles.bundle.css`
      * `scripts`: `news/projects/all/turnout/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/turnout/",
      "url": "http://static.startribune.com/news/projects-staging/all/turnout/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/turnout/",
      "url": "http://static.startribune.com/news/projects/all/turnout/"
    }
  }
}
```
